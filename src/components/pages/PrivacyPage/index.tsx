        ...
        <div className="w-3/5 max-md:w-full">
          <div className="mx-12 max-md:mx-4 pb-16 text-smx max-md:text-sm text-midblack max-md:space-y-2 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <li>
                You have shared information for us to assess your suitability
                for our product
              </li>
              <li>You subscribe to news and updates</li>
              <li>You have applied for a job or secondment with us</li>
              <li>
                You are representing your organisation and wish to communicate
                with us
              </li>
              {/* </ul> */}
            </div>
            ...
            <div className="space-y-4">
              <li>
                ...
                previous address and date of birth.
              </li>
              <li>
                Data for job applicants including employment history, education,
                experience, work permit, and visa status.
              </li>
              <li>
                Contact Data including email address, telephone numbers, home
                address, employer address, employer name.
              </li>
              <li>
                Account Data including information you give us when you register
                your account.
              </li>
              <li>
                Financial Data including account and card payment details, bank
                income, savings, spending and credit history.
              </li>
              <li>
                Technical Data including internet protocol (IP) address, browser
                type and version, location, browser plug-in types and versions,
                operating system and platform, and other technology on the
                devices you use to access the website and services.
              </li>
              <li>
                Application Data including details about your family and living
                situation, property preferences and housing history.
              </li>
              <li>
              ...
              <li>
                Marketing and Communications Data including your consent to get
                updates from us.
              </li>
            </div>
            <p>
            ...
            <div>
              ...
              <li>enter into a partnership to buy a home</li>
              <li>improve your experience</li>
              <li>
                provide you with marketing information about us and our services
                (you can unsubscribe at any time)
              </li>
              <li>let you know about changes to the website and service</li>
              <li>
